...
ActiveRecord::Schema[8.0].define(version: 2025_03_20_061350) do
  create_schema "auth"
  ...
  create_table "follows", force: :cascade do |t|
    ...
    t.index ["follower_id", "influencer_id"], name: "index_follows_on_follower_id_and_influencer_id", unique: true
    t.index ["follower_id"], name: "index_follows_on_follower_id"
    t.index ["influencer_id"], name: "index_follows_on_influencer_id"
  end
  ...
  add_foreign_key "follows", "users", column: "influencer_id"
